...
export class UpdateBillingModels1775108417062 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`concepts\` DROP COLUMN \`priceUsd\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`concepts\` ADD \`priceUsd\` decimal(10,2) NOT NULL DEFAULT 0.00`);
    }
