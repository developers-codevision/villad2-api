...
export class AddTypeAndIdentityCardToStaff1775001784057 implements MigrationInterface {
    name = 'AddTypeAndIdentityCardToStaff1775001784057'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`staff\` (\`id\` int NOT NULL AUTO_INCREMENT, \`staffname\` varchar(100) NOT NULL, \`expNumber\` varchar(20) NOT NULL, \`type\` enum ('gerente', 'supervisora', 'Tec Contable', 'Recepcionista') NOT NULL DEFAULT 'Recepcionista', UNIQUE INDEX \`IDX_6a0fba7f3eb61c4aeb2d50bbbc\` (\`staffname\`), UNIQUE INDEX \`IDX_88795054038a91eee408cfec5b\` (\`expNumber\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
