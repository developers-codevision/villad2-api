...
export class DigitalMenuSchema1722100000000 implements MigrationInterface {
  name = 'DigitalMenuSchema1722100000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKey('category_product', new TableForeignKey({
      columnNames: ['product_id'], referencedColumnNames: ['id'], referencedTableName: 'products', onDelete: 'CASCADE',
    }));
