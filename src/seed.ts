...
const roomsData = [
  {
    ...
    descriptionEn:
      'This is the first room on the ground floor, associated with the Isle of Pines, according to the Villa theme.',
    pricePerNight: 42,
    baseCapacity: 2,
    extraCapacity: 0,
    extraGuestCharge: 10,
  ...
  },
  {
    ...
    descriptionEn:
      'This is the 2nd room on the ground floor, associated with the former province of Pinar del Río, according to the Villa theme.',
    pricePerNight: 48,
    baseCapacity: 2,
    extraCapacity: 0,
    extraGuestCharge: 10,
  ...
  },
  {
    ...
    descriptionEn:
      'This is the third room on the ground floor, associated with the former province of Matanzas, according to the Villa theme.',
    pricePerNight: 48,
    baseCapacity: 2,
    extraCapacity: 0,
    extraGuestCharge: 10,
  ...
  },
  {
    ...
    descriptionEn:
      'This is the first room on the upper floor, associated with the former province of Havana, according to the Villa theme. It is large and also has an additional sofa bed. Up to 4 people can sleep in this room.',
    pricePerNight: 60,
    baseCapacity: 2,
    extraCapacity: 2,
    extraGuestCharge: 15,
  ...
  },
  {
    ...
    descriptionEn:
      'This is the second room on the upper floor, associated with the former province of Las Villas, according to the Villa theme.',
    pricePerNight: 48,
    baseCapacity: 2,
    extraCapacity: 0,
    extraGuestCharge: 10,
  ...
  },
  {
    ...
    descriptionEn:
      'This is the third room on the upper floor, associated with the former province of Camagüey, according to the Villa theme.',
    pricePerNight: 48,
    baseCapacity: 2,
    extraCapacity: 0,
    extraGuestCharge: 10,
  ...
  },
  {
    ...
    descriptionEn:
      'This is the fourth room on the upper floor, associated with the former province of Oriente, according to the Villa theme. It is the largest room, suitable for families, where up to 4 people can sleep comfortably.',
    pricePerNight: 54,
    baseCapacity: 2,
    extraCapacity: 2,
    extraGuestCharge: 15,
  ...
  },
  {
    ...
    descriptionEn:
      'Independent apartment with private entrance, fully equipped for maximum comfort. Includes living room, kitchen, bathroom and private bedroom. Perfect for families or extended stays.',
    pricePerNight: 85,
    baseCapacity: 2,
    extraCapacity: 3,
    extraGuestCharge: 20,
...
const promotionsData = [
  {
    titleEn: 'Business Meetings / Product Launches Offer',
    titleEs: 'Oferta para reuniones de trabajo / Lanzamientos de productos',
    maxPeople: 15,
    minPeople: 5,
    time: '4 horas',
    services: [
  ...
  {
    titleEn: 'Couples Accommodation Offer',
    titleEs: 'Oferta de alojamiento para parejas',
    maxPeople: 0,
    minPeople: 0,
    time: '20 horas',
    services: [
  ...
  {
    titleEn: 'Sports Events Broadcasting Offer',
    titleEs: 'Oferta para disfrute de transmisión de eventos deportivos',
    maxPeople: 15,
    minPeople: 5,
    time: '4 horas',
    services: [
  ...
  {
    titleEn: 'Families and Friends Offer with Advance Reservation',
    titleEs: 'Oferta para familias y amigos con previa reservación',
    maxPeople: 30,
    minPeople: 5,
    time: '',
    services: [
      ...
      'Juegos de mesa de diversos tipos / Various board games',
      'Ofertas puntuales de la carta del hostal / Special offers from the hostel menu',
      'Completa con congri, vianda frita, ensalada mixta y plato fuerte / Complete with congri rice, fried vegetables, mixed salad and main course',
  ...
  {
    titleEn: 'Venue Rental for Weddings / Birthdays / Baby Showers',
    titleEs: 'Alquiler del local para bodas / cumpleaños / Baby shower',
    maxPeople: 40,
    minPeople: 0,
    time: '4 horas',
    services: [
    ...
    descriptionEn:
      'Regardless of the rental, the hostel can arrange decoration, clowns, master of ceremonies, wedding ceremonies, etc., or the client can subcontract them. No outside beverages allowed (only those contracted at the hostel). Buffet and cake can be subcontracted.',
    descriptionEs:
...
async function seed() {
  ...
  try {
    ...
    for (const promoData of promotionsData) {
      ...
      console.log(`   ✓ "${promo.titleEs}" creada`);
    }
