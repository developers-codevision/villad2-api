...
const promotionsData = [
  {
    ...
    checkInTime: '',
    checkOutTime: '',
    photo: 'media/promotions/Oferta para reuniones de trabajo.jpg',
  ...
  },
  {
    ...
    checkInTime: '16:00',
    checkOutTime: '12:00',
    photo: 'media/promotions/Oferta de alojamiento para parejas.jpg',
    status: PromotionStatus.ACTIVE,
  },
  {
    ...
    checkInTime: '',
    checkOutTime: '',
    photo: 'media/promotions/Oferta para disfrute de transmisión de eventos deportivos.jpg',
    status: PromotionStatus.ACTIVE,
  },
  {
    ...
    checkInTime: '',
    checkOutTime: '',
    photo: 'media/promotions/Oferta para familias y amigos con previa reservación.jpg',
    status: PromotionStatus.ACTIVE,
  },
  {
    ...
    checkInTime: '',
    checkOutTime: '',
    photo: 'media/promotions/Alquiler del local para bodas.jpg',
    status: PromotionStatus.ACTIVE,
  },
];
